...
public class AddCommentActivity extends AppCompatActivity {
    ...
    private void updateToMySQL() {
        ...
        try {
            ...
            Toast.makeText(AddCommentActivity.this, "Update Successful", Toast.LENGTH_SHORT).show();
            finish();

        } catch (Exception e) {
            Toast.makeText(AddCommentActivity.this, "Cannot Update to Server", Toast.LENGTH_SHORT).show();
        }
